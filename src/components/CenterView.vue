...
const centerInfo = ref([
  {
    ...
    name: "北斗应用技术研发实验室",
    intro:
      "北斗应用技术研发实验室将致力于新一代GNSS接收机的创新研究，重点转化高精度高可靠性定位服务，GNSS信号安全监测，及GNSS遥感等多方面研发成果与相关技术，积极联合当地政府部门及产业链企业构建产学研协同平台，推动北斗技术在自动驾驶、智慧城市、飞行安全、防灾减灾等场景的示范应用，为合肥及长三角地区培育空天信息领域专业人才，助力国家卫星导航产业高质量发展。",
    direction: [
      "GNSS高精度高可靠性接收机",
      "GNSS-R水平面监测站",
      "GNSS信号质量监测及干扰源定位系统",
    ...
    developPlan: [
      {
        item: "产学研合作",
        content:
          "联合当地大学、研究院及行业龙头企业，共建北斗技术联合实验室，推动协同创新。",
      },
      {
        item: "关键技术创新",
        content:
          "实现高精度定位、环境监测与干扰源定位等技术转化，重点解决复杂多变环境下的适用性问题。",
      },
      {
        item: "成果转化落地",
        content:
  ...
  },
  {
    ...
    name: "生物传感器研发实验室",
    intro:
      "生物传感器研发实验室将聚焦生物医疗精密传感技术的研发与产业化，重点突破可穿戴健康监测、无创医学影像、神经调控等前沿领域，深度融合材料科学、电子工程与生物医学技术，构建‘基础研究-技术转化-产业孵化’的全链条创新体系。通过深化政产学研合作，整合香港理工大学尖端科研资源与合肥市产业优势，致力打造国际一流的生物传感技术研发高地，为合港两地及长三角地区培育高端医疗器械人才，推动精准医疗产业创新发展。",
    direction: [
  ...
  },
  {
    ...
    name: "医用超声成像与传感研发实验室",
    intro:
      "医用超声成像与传感研发实验室将围绕超声换能器、超声成像算法与超声成像系统三条主线开展协同攻关：在换能器方面聚焦高性能、便携化探头的材料与制造技术；在成像算法方面面向新型阵列与应用场景，发展高分辨率、低噪声的超声成像方法；在系统方面推进超声模拟前端、FPGA/SoC信号处理及与移动终端的融合，形成从核心器件到整机的完整技术链。研发实验室将依托合港优势资源，服务医疗超声设备国产化与精准医疗应用，推动高端超声可视化医疗器械在临床各科及基层的落地。",
    direction: [
    ...
    developPlan: [
      {
        item: "深化产学研合作",
        content:
          "基于实验室在医用超声换能器和成像系统方面的优势，深化和合肥地区企业和高校研发力量的合作。",
      },
      {
        item: "孵化初创企业",
        content: "转化实验室的研究成果，孵化初创企业，提高创新文化。",
      },
      {
        item: "建立服务中心",
        content:
          "充分利用实验室研究成果的优势，为合肥地区研究机构提供更多的科研支持。",
      },
    ],
  ...
  },
  {
    ...
    name: "超声神经调控和超声诊疗实验室",
    intro:
      "超声神经调控和超声诊疗实验室致力于突破传统医学影像与神经调控技术局限，聚焦两大前沿方向：无创功能超声成像系统与超声神经调控系统。在功能成像方面，研发超高频声波及多模态融合技术，结合AI算法，实现组织功能参数的动态定量评估，推动超声诊断从形态学向功能学跨越。在神经调控方面，利用超声精准无创特性，开发新型神经干预工具，为帕金森病、抑郁症等神经系统疾病提供安全、可逆的治疗方案，并助力脑科学基础研究。通过医工交叉与临床转化，本实验室旨在成为国际领先的超声诊疗创新平台，为疾病诊疗和脑机接口等领域提供变革性技术支撑。",
    direction: [
    ...
    developPlan: [
      ...
      },
      {
        ...
        content: "为实验室技术成果提供开放共享平台，服务本地科研和医疗需求。",
      },
    ],
    img: "",
  },
  {
    ...
    name: "行星遥感与机器视觉研发实验室",
    intro:
      "行星遥感与机器视觉研发实验室作为推动航天科技与区域创新深度融合的重要平台，以「产学研协同创新」和「航天科普教育，为双轮驱动，致力于将香港理工大学在遥感技术、机器视觉等领域的前沿科研成果转化为服务国家航天战略和地方经济发展的实际生产力。中心聚焦两大核心方向：一是产学研协同创新，依托香港理工大学在行星遥感领域的国际领先技术，与合肥及周边科研机构共建联合实验室，推动航天领域的科研合作。二是航天科普教育，通过打造沉浸式航天科普教育平台、开发「AI+航天」互动式教育产品，将香港理工大学的航天资源转化为科普教育内容，与合肥及周边企业合作，推动航天科普教育发展。",
    direction: [
      "“月球 / 火星着陆区虚拟实境”VR 产品",
      "“AI + 航天” 互动教育产品",
    ],
  ...
  },
  {
    ...
    name: "飞行器与低空导航研发实验室",
    intro:
      "飞行器与低空导航研发实验室将聚焦无人机安全飞行技术与低空监控系统的创新研发，联合当地产业领军企业，针对城市复杂环境开展高精度定位、智能避障及多源感知融合技术攻关。通过政产学研协同创新，推动无人机在物流配送、安全巡检、应急救援等场景的规模化应用，同时构建‘5G-A+雷达+光电’一体化低空监控平台，实现城市低空态势智能感知与风险预警，为智慧城市建设和低空经济发展提供核心技术支撑，培育高端无人机与低空经济领域专业人才。",
    direction: [
      "空基平台与多无人机协作系统：研发多无人机在无GPS环境下的快速现场部署，开发一种时空轨迹优化算法。",
      "无人机高层救援系统：致力于研发创新型无人机空中作业平台，通过特殊的智能抓取和递送模块为灾害救援提供解决方案。",
    ...
    developPlan: [
      {
        item: "深化产学研合作",
        content:
          "基于实验室在无人机和机器人方面的研究，深化和合肥地区企业和高校研发力量的合作。",
      },
  ...
  },
  {
    ...
    intro:
      "肿瘤放疗疗效管理辅助机器人研发实验室专注于放疗疗效管理领域，致力于开发基于人工智能与多模态感知的放疗疗效管理机器人技术。研发团队在医疗机器人、医学影像分析及放射治疗领域具备深厚积累，依托产学研医协同创新模式，与医疗机构及企业深度合作，提供高精度、高一致性的智能评估解决方案，推动肿瘤放疗疗效管理进入客观化与智能化的新纪元。",
    direction: [
...
<template>
  <!-- <div class="crumbs">
    <RouterLink to="/research">研究实验室</RouterLink>
