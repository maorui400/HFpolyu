...
const newsInfo = ref([
  {
  ...
  },
   {
    ...
    { type: "image", content: _newsImageObj.new2[0]},
        ...
        type: "text",
        content:
          "陈清泉院士以《人工智能赋能，能源革命和汽车革命新征程》为题，首先论述科学迭代的重要性，科学发现、科技革命、产业革命推动人类社会经济的发展。科学是真理，是规律，科学回答的问题是“为什么？为何？”。工程是科学+技术+管理，工程回答的问题是“如何实现？如何？”。他提倡工程哲学，就是有目的、有思想、有方法、可以完成政、产、学、研、用、金融合。然后他深入阐释了人工智能如何深度融入能源与汽车产业变革。他指出，人工智能正推动产业向智能化、绿色化转型，并提出将汽车技术、电机技术、电力驱动技术、电力电子技术及现代控制理论有机融合的电动汽车研究核心框架。他创新性提出了“四网四流融合”理论框架，强调通过能源网、信息网、交通网、人文网的深度融合，推动能源革命、信息革命与交通（出行）革命的协同发展，旨在实现以人为本、人与自然和谐共生的可持续发展目标。他深度剖析了汽车革命“上下半场”的发展路径，并指出人工智能引擎正成为驱动材料研发、电池技术等关键领域创新的核心力量。陈清泉院士表示，“今天电动汽车的属性发生了变化。电动汽车的心脏是电机和电池、能源是电力。电力能源可以双向，而传统的内燃机车的能源是汽油或柴油、是单向的，所以电动汽车可以推动能源革命。电动汽车的大脑是操作系统和芯片，所以电动汽车可以推动智慧交通，智慧城市和智慧社会。",
      },
          { type: "image", content: _newsImageObj.new2[1]},
          {
        type: "text",
        content:
          "杨红霞教授以《协作生成式人工智能(Co-GenAI):一种融合驱动的新型框架》为主题，系统阐述了其团队提出的新一代AI开发范式。她指出，当前GenAI在领域专家与AI专家之间存在协作鸿沟，而Co-GenAI旨在通过去中心化的协作平台，实现“共建模型、数据本地化”的融合开发。杨教授重点介绍了其在超低比特（如FP8）大模型训练、高效无约束模型融合等方面的世界级技术突破，这些技术能大幅降低计算成本与时间，并展示了其在医疗等领域构建高性能专业模型（如顶尖的癌症GenAI模型）的成功应用。该框架致力于让AI开发更高效、更低成本、更具包容性，推动科学基础模型的全球协作。",
      },
              { type: "image", content: _newsImageObj.new2[2]},
          {
        type: "text",
        content:
          "此次讲座是香港理工大学合肥技术创新研究院推动学术交流与产学研合作的重要举措之一。未来，研究院将继续搭建高水平对话平台，促进知识分享与技术创新，助力区域科技人才培育与产业升级。",
      },
    ]}
    ]);
